...
class ArticleCommentServiceTest {
		...
		@InjectMocks
		private ArticleCommentService articleService;
		...
		void givenArticleId_whenSearchingArticleComments_thenReturnsArticleComments() {
				...
				// When
				List<ArticleCommentDto> actual = articleService.searchArticleComments(articleId);
		...
		void givenArticleCommentInfo_whenSavingArticleComment_thenSavesArticleComment() {
				...
				// When
				articleService.saveArticleComment(dto);
		...
		void givenArticleCommentInfo_whenUpdatingArticleComment_thenUpdatesArticleComment() {
				...
				// When
				articleService.updateArticleComment(dto);
		...
		void givenArticleCommentId_whenDeletingArticleComment_thenDeletesArticleComment() {
				...
				// When
				articleService.deleteArticleComment(articleCommentId);
